...
/**
 * Template Name: Membranas Asfáltica
 *
 *
 * @package WordPress
 * @subpackage Transaco
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="description">
            <div class="column">
                <div>
                    <?php echo get_field('descripcion', $id); ?>
                </div>
                <div class="prod-aa-cont">
                    ...
                    <div class="prod-aa-item">
                        <div class="cont">
                            ...
                            <div class="info" style="display: flex; align-items: flex-start;">
                                <div class="column">
            ...
            <div class="column">
                <div class="logo-chile" style="background-image: url(<?php echo get_template_directory_uri() . '/img/concave.png' ?>)">
                    <a href="http://asimpchile.com/web/" target="_blank"><img src="<?php echo get_template_directory_uri() . '/img/logo-chile.png'; ?>"></a>
                </div>
            </div>
        </div>
