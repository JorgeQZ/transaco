...
<style>
    ...
    #section-video .cont-video video{
        position: absolute;
          top: 0;
          left: 0;
          width: 100%;
...
<section id="section-video">
    <div class="cont-video">
        <video preload playsinline autoplay loop autobuffer muted controls>
			<source src="<?php echo get_template_directory_uri() ?>/img/corporativo-owens.mp4" type="video/mp4">
    ...
    <div>
        <p>
           <span class="bold__">Oficinas y Showroom</span><br>
				...
				Las Condes<br>
				<br>
				* Para visitas presenciales, coordinar<br>
				previamente con los siguientes contactos:<br><br>

				<strong>Jonathan Cabrera (ATC)</strong><br>
			<a href="tel:+56 9 6317 0779" target="_top">+56 9 6317 0779</a><br>
			<a href="mailto:contactochile@owenscorning.com" target="_top">contactochile@owenscorning.com</a>

            <br><br>

			<strong>Felipe Rojas (especificador técnico)</strong><br>
